...
export function Header({ isMobile, toggleMenu, isMenuOpen }: HeaderProps) {
  return (
    <header className="fixed top-0 left-0 w-full p-4 md:p-0 md:top-8 md:left-8 z-[100] flex justify-between items-center md:block bg-black/70 backdrop-blur-sm md:bg-transparent md:backdrop-blur-none">
